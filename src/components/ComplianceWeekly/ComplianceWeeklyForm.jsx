      ...
      <div className="form-container">
        ...
        <div style={{ 
          ...
          {allMatch ? (
            ...
            <p style={{ margin: '10px 0 0 0', color: '#dc3545' }}>⚠️ Totals must match to submit</p>
          )}
        </div>
        ...
        <form onSubmit={handleSubmit} className="grid-form">
          ...
          <div className="form-row">
            ...
            <label>
              <span style={{ opacity: 0.7 }}>Total Households (calculated):</span>
              <input
                type="text"
